...
../configure \
	...
	--arch=${ndk_triple%%-*} --cpu=$cpu --pkg-config=pkg-config --pkg-config-flags="--static" \
	--extra-libs="-lz" --extra-cflags="-I$prefix_dir/include $cpuflags" \
	--extra-ldflags="-L$prefix_dir/lib" --extra-ldexeflags="-static"\
